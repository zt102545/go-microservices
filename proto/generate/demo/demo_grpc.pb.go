...
const (
	Demo_Ping_FullMethodName = "/bot.Demo/Ping"
)
...
func (c *demoClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingResp, error) {
...
func (UnimplementedDemoServer) Ping(context.Context, *PingReq) (*PingResp, error) {
...
func _Demo_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).Ping(ctx, req.(*PingReq))
	}
...
var Demo_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/source/demo.proto",
}
